            ...
            <div className="flex justify-center w-full">
              <div
                className="
                  group relative
                  flex flex-wrap
                  h-full w-full max-w-4xl rounded-3xl bg-clip-padding
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-offGray text-20 sm:text-28">
                      ...
                      creating open-source apps under a unified
                      brand.
                    </span>
                  </div>
                  {biggerThan480 ? (
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-offGray text-20 sm:text-28">
                      Compiled snippets from previous projects,
                      school assignments, and client work.
                    </span>
                  </div>
                  {biggerThan480 ? (
                    <div
