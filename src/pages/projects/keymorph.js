...
import projectBannerKeymorph from "/public/images/keymorph/projectBannerKeymorph.png";
          ...
          >
            ...
            >
              ...
              <div
                ...
                "
              >
                <span className="text-44 font-black 375:text-52">Keymorph</span>
              ...
              >
                <div className="w-full h-fit lg:w-1/2 flex align-top border-l-8 border-offPaper pl-20">
                  <span className="text-20 text-offGray font-normal 375:text-24 lg:text-28">
                    ...
                    creating open-source apps under one brand.
                  </span>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex flex-wrap ml-4">July 2021 — ∞</div>
                  </span>
                  ...
                  >
                    ...
                    <div className="ml-4">Hobby Project</div>
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="mt-40 space-y-16">
                ...
                >
                  ...
                  <span className="w-fit font-bold">
                    Keymorph&apos;s logo, contact information, and applications:{" "}
                    <b>&quot;Notes&quot;</b> <i>(left)</i> and{" "}
                    <b>&quot;Website&quot;</b> <i>(right)</i>.
                  </span>
                </div>
              </div>
